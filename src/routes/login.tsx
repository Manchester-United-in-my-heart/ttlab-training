      ...
      <div className="flex flex-col justify-center items-center font-['Public Sans]">
        <svg width="108" height="60" viewBox="0 0 108 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_6_18331)">
            <path d="M45.0034 12.5996C45.0034 19.6966 30.475 36 27.9913 36C27.4338 36 27.0034 35.5555 27.0034 35.0123C27.0034 31.4215 37.7992 20.4162 37.7992 13.3757C37.7992 5.33333 28.7957 3.2381 28.7957 1.08642C28.7957 0.627868 29.2614 0.0070566 29.967 0.0070566C32.0979 1.92365e-06 45.0034 5.29806 45.0034 12.5996Z" fill="#E31931" />
            <path d="M59.4046 12.5996C59.4046 19.6966 44.8762 36 42.3925 36C41.8351 36 41.4047 35.5555 41.4047 35.0123C41.4047 31.4215 52.2004 20.4162 52.2004 13.3757C52.2004 5.33333 43.1969 3.2381 43.1969 1.08642C43.1969 0.627868 43.6626 0.0070566 44.3682 0.0070566C46.4991 1.92365e-06 59.4046 5.29806 59.4046 12.5996Z" fill="black" />
            <path d="M63.0035 23.4004C63.0035 16.2963 77.5319 0 80.0157 0C80.5731 0 81.0035 0.444445 81.0035 0.987655C81.0035 4.57848 70.2077 15.5838 70.2077 22.6243C70.2077 30.6667 79.2113 32.7619 79.2113 34.9136C79.2113 35.3721 78.7456 35.993 78.04 35.993C75.909 35.993 63.0035 30.7019 63.0035 23.4004Z" fill="black" />
            ...
            <path
              ...
              fill="black"
            />
            <path d="M20.7378 54.5962H19.6229V59.8237H17.993V48.1623H19.6229V53.2911H20.5896L23.6731 48.1623H25.6135L21.9444 53.7002L25.8958 59.8308H23.906L20.7378 54.5962Z" fill="black" />
            <path d="M30.9973 53.8272H31.0467L33.4316 48.1623H35.238L31.8087 55.6262V59.8237H30.1929V55.5203L26.806 48.1623H28.6264L30.9973 53.8272Z" fill="black" />
            <path
            ...
            <path d="M61.5924 54.7091H57.6762V58.0107H62.2839V59.8308H55.3901V48.1623H62.2627V49.9824H57.6692V52.889H61.5853V54.7091H61.5924Z" fill="#E31931" />
            <path
              ...
              fill="#E31931"
            />
            <path d="M81.0741 59.8237H78.795V54.9912H75.1752V59.8237H72.889V48.1623H75.1752V53.1782H78.795V48.1623H81.0741V59.8237Z" fill="#E31931" />
            <path d="M85.0679 58.0036H89.3298V59.8237H82.7817V48.1623H85.0679V58.0036Z" fill="#E31931" />
            <path d="M96.668 57.3334H93.5916L92.9636 59.8237H90.6633L93.9514 48.1623H96.3223L99.6033 59.8237H97.3031L96.668 57.3334ZM94.0573 55.5133H96.2023L95.151 51.3863H95.1016L94.0573 55.5133Z" fill="#E31931" />
            <path
      ...
      <div>
        <form className="flex flex-col justify-center items-center mt-[50px]">
          <div className="flex flex-col justify-center items-start">
            ...
            <input placeholder="Nhập email" className="border-[1px] border-[#E31931] rounded-[5px] w-[500px] h-[50px] mt-[10px] pl-[10px]" onChange={(e) => setUsername(e.target.value)} />
          </div>
          <div className="flex flex-col justify-center items-start relative my-[25px]">
            <label className="text-[18px]">Mật khẩu</label>
            <input id="password" className="border-[1px] border-[#E31931] rounded-[5px] w-[500px] h-[50px] mt-[10px] pl-[10px]" type="password" onChange={(e) => setPassword(e.target.value)} />
            <span>
              {showPassword ? (
                <FaRegEyeSlash
          ...
          <button
            ...
            type="button"
            className="w-[500px] h-[50px] bg-[#0F60FF] mt-[10px] rounded-[5px] text-[18px] text-white"
          >
            Đăng nhập
          </button>
        </form>
