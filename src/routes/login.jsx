      ...
      <div>
        <form className="flex flex-col justify-center items-center mt-[50px]">
          <div className="flex flex-col justify-center items-start">
            ...
            <input placeholder="Nhập email" className="border-[1px] border-[#E31931] rounded-[5px] w-[500px] h-[50px] mt-[10px] pl-[10px]" />
          </div>
          <div className="flex flex-col justify-center items-start relative my-[25px]">
            <label className="text-[18px]">Mật khẩu</label>
            <input id="password" className="border-[1px] border-[#E31931] rounded-[5px] w-[500px] h-[50px] mt-[10px] pl-[10px]" type="password" />
            <span>
              {showPassword ? (
                <FaRegEyeSlash
          ...
          <button type="submit" className="w-[500px] h-[50px] bg-[#0F60FF] mt-[10px] rounded-[5px] text-[18px] text-white">
            Đăng nhập
          </button>
        </form>
